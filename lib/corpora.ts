...
export const CORPORA: Record<CorpusId, CorpusDefinition> = {
  security: {
    ...
    exampleQuestions: [
      ...
      'Are there any critical remote-code-execution vulnerabilities reported?',
      ...
      'Are there any authentication bypass vulnerabilities reported?',
    ],
  ...
  governance: {
    ...
    exampleQuestions: [
      'What background environmental data exists for major infrastructure projects like HS2?',
      'What data security standards or reviews apply to NHS and health data?',
      'What’s been said about algorithmic bias and online targeting in government data policy?',
      'What research exists on the quality of ethnicity data collection?',
      'What research has been done on data standards and governance for Smart Data?',
    ],
    defaultTagline: 'Ask a plain-language question, get a cited answer.',
  },
}
